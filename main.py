...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.entry = customtkinter.CTkEntry(self.tabview.tab("Generate"), placeholder_text="Data to decode as QR code")
        self.entry.grid(row=1, column=0, columnspan=2, padx=(20, 0), pady=(20, 20), sticky="nsew")

        self.main_button_1 = customtkinter.CTkButton(master=self.tabview.tab("Generate"), fg_color="transparent", border_width=2, text_color=("gray10", "#DCE4EE"))
